...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('Verifica se o circle retorna undefined, caso o parâmetro passado não seja um número', () => {
    expect(circle('2')).toBe(undefined);
  });
  it('Verifica se o circle retorna um objeto', () => {
    expect(typeof circle(3)).toBe('object');
  });
  it('Verifica se o circle retorna undefined, caso o parâmetro passado não seja um número', () => {
    expect(circle(undefined)).toBeUndefined();
  });
  it('Verifica se objeto retornado, a função retorna uma `key` com `value` igual à circunferência correta para um círculo de raio 2.', () => {
    expect(circle(2).circumference).toEqual(12.56);
  });
  it('Verifica se objeto retornado, a função retorna uma `key` com `value` igual à area correta para um círculo de raio 3.', () => {
